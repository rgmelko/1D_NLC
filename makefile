OBJS = NLC_1D_TFIM.o GenHam.o Lanczos_07.o lapack.o graphs.o #Lattice_16B.cpp
CC = g++
CFLAGS = -O2 
...
NLC_1D_TFIM.o : NLC_1D_TFIM.cpp CPU/GenHam.h CPU/Lanczos_07.h CPU/lapack.h CPU/simparam.h
